      ...
      itemStyle: {
        normal: {
          color: {
            ...
            r: 0.5,
            colorStops: [{
              offset: 0.3, color: 'rgb(86, 122, 246)'
            }, {
              offset: 0.4, color: 'rgb(140, 165, 250)'
            }, {
              offset: 0.8, color: 'rgb(140, 165, 250)'
            }, {
              offset: 0.85, color: 'rgb(221, 228, 253)'
            }, {
              offset: 1, color: 'rgb(221, 228, 253)' // 100% 处的颜色
            }],
          },
